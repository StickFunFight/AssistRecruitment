...
?>
            ...
            <div class="row QaTopMargin">
                <div class="col-sm-6">
                    <input class="form-control form-control-lg" id="Filter" type="text"
                           placeholder="Zoek naar een questionair.">
                </div>
                <div class="col-sm-6">
                    <button type="button" class="btn add-container__btn ButtonRight" id="AddQuestionair"><i
                                class="fas fa-plus-circle"></i> Questionair toevoegen
                    </button>
                </div>
            </div>
            <div>
    ...
    <div class="modal fade" id="questionairArchiveModal" tabindex="-1" role="dialog"
         aria-labelledby="questionairArchiveModal" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form method="POST">
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Weet je zeker dat je de questionair: ""
                                wilt archiveren?</label>
                        </div>
                        <div class="modal-footer">
                            <button type="button" name="btnArchiveerQair" id="btnArchiveer" class="btn btn-danger"
                                    value="Ja">Ja
                            </button>
