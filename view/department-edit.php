                ...
                <form method="POST" action="department-edit?department=<?php echo $departmentID; ?>">
                    ...
                    <div class="row ce--from-row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="txtDepartmentName" class="form-control ce--input"
                                   value="<?php echo $department->getDepartmentName(); ?>" required>
                        </div>

                        <div class="col-sm-6">
                            <label class="ce__label">Customer</label>
                            <select name="cbxCustomer" class="form-control" id="customerSelect"
                    ...
                    <div class="row ce--form-row">
                        <div class="col-sm-6">
                            ...
                            <textarea name="txtDepartmentComment" class="form-control ce--input"
                                      rows="5"><?php echo $department->getDepartmentComment(); ?></textarea>
                        </div>
                    ...
                    <div class="row ce--margin">
                        <div class="col-sm-12">
                            <input type="submit" name="btnUpdate" class="btn ce__update-button"
