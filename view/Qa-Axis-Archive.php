...
require_once '../functions/datalayer/AxisDatabase.php';
$AD = new AxisDatabase();
$Aid = "1";
?>

<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" >archiveer axis</button>
...
<script>
    ...
    $('#btnArchiveer').click(function () {
        $.ajax({
            url: 'QA-Axis-Archive.php',
            type: 'post',
            data: { "AxisName": $('#textField').val()},
