...
<div class="container login-form pb-1">
    <form method="post" class="form-group">
        ...
        <button name="submitLogin" onclick="location.href='http://localhost/AssistRecruitment/view/loginScreen.php'"
                type="button" class="btn btn-primary mt-2 mb-4 float-left formButton">Terug
        </button>
        <button name="submitPasswordReset" type="submit" class="btn btn-primary mt-2 mb-4 float-right formButton">
            Bevestigen
        </button>
    </form>
</div>
