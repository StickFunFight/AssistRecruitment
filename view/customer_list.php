            ...
            <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="add-container">
                                <a href="customer-add" class="btn add-container__btn"><i
                                            class='fas add-container--icon'>&#xf055;</i> Add customer</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <table class="tab-table table table-hover" id="filterTable">
                    ...
                    <tr class="tab-table__row">
                        ...
                        <th class="customer__th_name">Name
                        ...
                        <th class="customer__th_comment">Comment
                        ...
                        <th class="customer__td_refrence">Reference
                    ...
                    foreach ($listUsers as $user) {
                        ...
                        <tr class="tab-table__row filter__row">
                            <td class="tab-table__td"
                                onclick="toDetails(<?php echo $user->getCustomerID(); ?>)"><?php echo $user->getCustomerName(); ?> </td>
                            <td class="tab-table__td"
                                onclick="toDetails(<?php echo $user->getCustomerID(); ?>)"><?php echo $user->getCustomerComment(); ?></td>
                            <td class="tab-table__td"
                                onclick="toDetails(<?php echo $user->getCustomerID(); ?>)"><?php echo $user->getCustomerReference(); ?></td>

                            <td class="tab-table__td">
                                <a class="editKnop" href="customer-edit?customer=<?php echo $user->getCustomerID(); ?>"><i
                                ...
                                switch ($userStatus) {
                                    case 'Archived':
                                        ?>
                                        <a class="deleteKnop" name="deleteKnop" href="#" data-toggle="modal"
                                           data-target="#deleteModal" id='<?php echo $user->getCustomerID(); ?>'
                                    ...
                                    default:
                                        ?>
                                        <a class="deleteKnop" name="archiveKnop" href="#" data-toggle="modal"
                                           data-target="#archiveModal" id='<?php echo $user->getCustomerID(); ?>'
                                           onClick="reply_click(this.id)"><i
                                                    class="fas tab-table__icon">&#xf187;</i></a>
                                        <?php
                                        break;
                        ...
                        $('#btnArchive').click(function () {
                            $.ajax({
                                ...
                                success: function (response) {
                                    window.location.href = 'customer_list?status=<?php echo $userStatus;?>'
                                }
                            });
                        });
