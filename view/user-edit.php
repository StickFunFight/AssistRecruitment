...
if (isset($_GET['user'])) {
    ...
    foreach ($detailsUser as $user) {
        ...
        <div class="page__container">
            <div class="container">
                ...
                <form method="POST" autocomplete="off" action="?user=<?php echo $user->getUserID(); ?>">
                    ...
                    <input type="hidden" name="txtCustomerID" id="custID"
                           value="<?php echo $user->getUserCustomerID(); ?>">

                    <div class="row ce--form-row">
                        <div class="col-sm-6">
                            <label for="name" class="ce__label">Name</label>
                            <input type="text" name="txtName" id="name" value="<?php echo $user->getContactName(); ?>"
                                   class="form-control ce--input" required/>
                        </div>

                        <div class="col-sm-6">
                            <label for="phoneNumber" class="ce__label">Phone number</label>
                            <input type="tel" name="txtPhoneNumber" id="phoneNumber"
                                   value="<?php echo $user->getUserPhoneNumber(); ?>" class="form-control ce--input"
                                   required/>
                        </div>
                    </div>
                    ...
                    <div class="row ce--form-row">
                        <div class="col-sm-6">
                            ...
                            <input type="email" name="txtEmail" id="email" value="<?php echo $user->getUserEmail(); ?>"
                                   class="form-control ce--input" required/>
                        </div>
                    ...
                    <div class="row ce--form-row">
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" name="cbxCustomer" id="customerSelect"
                                ...
                                foreach ($listCustomers as $customer) {
                                    if ($customer->getCustomerID() == $user->getUserCustomerID()) {
                                        ?>
                                        <option selected="selected"
                                                value="<?php echo $customer->getCustomerID(); ?>"><?php echo $customer->getCustomerName(); ?></option>
                                        <?php
                                    } else {
                                        ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <textarea name="txtUserComment" id="userComment" class="form-control ce--input"
                                      rows="5"><?php echo $user->getUserComment(); ?>
                            </textarea>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="customer__select">
                                            <select id="scanStatus" name="cbxScanStatus" class="form-control"
                                ...
                                <table class="tab-table table table-hover" id="filterTable">
                                    ...
                                    <tr class="tab-table__row">
                                        <th class="tab-table__head" onclick="sortTable(0)">Name
                                            <div class="table__icon-top"
                                                 onclick="sortTable('filterTable', 0, 'desc')"></div>
                                            <div class="table__icon-bottom"
                                                 onclick="sortTable('filterTable', 0, 'asc')"></div>
                                        </th>
                                        <th class="tab-table__head" onclick="sortTable(1)">Start date
                                            <div class="table__icon-top"
                                                 onclick="sortTable('filterTable', 1, 'desc')"></div>
                                            <div class="table__icon-bottom"
                                                 onclick="sortTable('filterTable', 1, 'asc')"></div>
                                        </th>
                                        <th class="tab-table__head" onclick="sortTable(2)">End date
                                            <div class="table__icon-top"
                                                 onclick="sortTable('filterTable', 2, 'desc')"></div>
                                            <div class="table__icon-bottom"
                                                 onclick="sortTable('filterTable', 2, 'asc')"></div>
                                        </th>
                                                ...
                                                switch ($scanStatus) {
                                                    case 'Archived':
                                                        ...
                                                        <a class="deleteKnop" href="#" data-toggle="modal"
                                                           data-target="#disconnectScanModal"
                                                           id='<?php echo $scan->getScanID(); ?>'
                                                    ...
                                                    default:
                                                        ...
                                                        <a class="deleteKnop" href="#" data-toggle="modal"
                                                           data-target="#disconnectScanModal"
                                                           id='<?php echo $scan->getScanID(); ?>'
                                                           onclick="setScanIDModal(<?php echo $scan->getScanID(); ?>)"><i
                                                                    class="fas fa-minus-circle"></i></a>
                                                        <?php
                                                        break;
                                                }
                            ...
                            <div class="col-sm-12">
                                ...
                                <table class="tab-table table table-hover" id="filterTable">
                                    ...
                                    <tr class="tab-table__row">
                                        ...
                                        <th class="tab-table__head" onclick="sortTable(1)">Comment
                                            <div class="table__icon-top"
                                                 onclick="sortTable('filterTable', 1, 'desc')"></div>
                                            <div class="table__icon-bottom"
                                                 onclick="sortTable('filterTable', 1, 'asc')"></div>
        ...
        <div class="modal fade" id="disconnectScanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
                    ...
                    <form>
                        <div class="modal-footer">
                            <form method="POST" autocomplete="off">
                                ...
                                <input type="submit" name="btnDisconnectModal" class="btn btn-primary"
                                       value="Disconnect" id="btnDisconnectModal">
                            </form>
