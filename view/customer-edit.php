...
if (isset($_GET['customer'])) {
    ...
    foreach ($detailsCustomer as $customer) {
                ...
                <form method="POST" action="customer-edit?customer=<?php echo $customerID; ?>">
                    ...
                    <div class="row justify-content-md-center ce--form-row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="txtCustomerName" id="customerName"
                                   value="<?php echo $customer->getCustomerName(); ?>" class="form-control ce--input"
                                   required/>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="txtcustomerRefrence" id="customerRefrence"
                                   value="<?php echo $customer->getCustomerReference(); ?>"
                                   class="form-control ce--input" required onchange=""/>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-sm-6">
                            ...
                            <textarea name="txtCustomerComment" id="customerComment" class="form-control ce--input"
                                      rows="5" onchange=""><?php echo $customer->getCustomerComment(); ?></textarea>
                    ...
                    <div class="row ce--margin">
                        <div class="col-sm-12">
                            ...
                            <input type="submit" name="btnUpdateAndExit" class="btn ce__update-button"
                                   value="Update customer and exit">
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="customer__select">
                                                <select id="userStatus" name="cbxDepartmentStatus" class="form-control"
                                                        onchange="updateTableStatus('Users', 'userStatus')">
                                                    <?php
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <input class="form-control input__filter" id="FilterUsers" type="text"
                                                   placeholder="Search...">
                                        </div>

                                        <div class="col-sm-2">
                                            <div class="add-container">
                                                <a href="#" class="btn add-container__btn" data-toggle="modal"
                                                   data-target="#addUserModal"><i class='fas add-container--icon'>&#xf055;</i>
                                                    Add user</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <table class="tab-table table table-hover" id="filterTableUsers">
                            ...
                            <tr class="tab-table__row">
                                ...
                                <th class="tab-table__head">Name
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableUsers', 0, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableUsers', 0, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Phone number
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableUsers', 1, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableUsers', 1, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Email
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableUsers', 2, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableUsers', 2, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Department
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableUsers', 3, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableUsers', 3, 'desc')"></div>
                                </th>
                            ...
                            foreach ($listUsers as $user) {
                                ...
                                <tr class="tab-table__row filter__row">
                                    <td class="tab-table__td"
                                        onclick="toDetails('Users', <?php echo $customerID; ?>, <?php echo $user->getUserID(); ?>)"><?php echo $user->getContactName(); ?></td>
                                    <td class="tab-table__td"
                                        onclick="toDetails('Users', <?php echo $customerID; ?>, <?php echo $user->getUserID(); ?>)"><?php echo $user->getUserPhoneNumber(); ?></td>
                                    <td class="tab-table__td"
                                        onclick="toDetails('Users', <?php echo $customerID; ?>, <?php echo $user->getUserID(); ?>)"><?php echo $user->getUserEmail(); ?></td>
                                    <td class="tab-table__td"
                                        onclick="toDetails('Users', <?php echo $customerID; ?>, <?php echo $user->getUserID(); ?>)"><?php echo $user->getUserDepartmentName(); ?></td>
                                    <?php
                                        ...
                                        switch ($userStatus) {
                                            case 'Archived':
                                                ...
                                                <a class="deleteKnop" href="#" data-toggle="modal"
                                                   data-target="#deleteContact" id='<?php echo $user->getUserID(); ?>'
                                                   onclick="setContactIDModalCustomerEdit(<?php echo $user->getUserID(); ?>)"><i
                                                            class="fas tab-table__icon">&#xf2ed;</i></a>
                                                <?php
                                                break;
                                            case 'Deleted':
                                            ...
                                            default:
                                                ?>
                                                <a class="deleteKnop" href="#" data-toggle="modal"
                                                   data-target="#archiveContact" id='<?php echo $user->getUserID(); ?>'
                                                   onclick="setContactIDModalCustomerEdit(<?php echo $user->getUserID(); ?>)"><i
                                                            class="fas tab-table__icon">&#xf187;</i></a>
                                                <?php
                                                break;
                    ...
                    <div class="ce-overview__table">
                            ...
                            <div class="col-sm-12">
                                <form method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="customer__select">
                                                <select id="departmentStatus" name="cbxDepartmentStatus"
                                                        class="form-control"
                                                        onchange="updateTableStatus('Departments', 'departmentStatus')">
                                                    <?php
                                                    // Checking if a status has been set
                                        ...
                                        <div class="col-sm-5">
                                            <div class="search__icon"><i class='fas search--icon'>&#xf002;</i></div>
                                            <input class="form-control input__filter" id="FilterDepartments" type="text"
                                                   placeholder="Search...">
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="add-container">
                                                <a href="#" class="btn add-container__btn" data-toggle="modal"
                                                   data-target="#addDepartmentModal"><i class='fas add-container--icon'>&#xf055;</i>
                                                    Add department</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <table class="tab-table table table-hover" id="filterTableDepartments">
                            ...
                            <tr class="tab-table__row">
                                <th class="tab-table__head">Name
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableDepartments', 0, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableDepartments', 0, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Comment
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableDepartments', 1, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableDepartments', 1, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Actions</th>
                            </tr>
                            </thead>
                            ...
                            foreach ($listDepartments as $department) {
                                ...
                                <tr class="tab-table__row filter__row">
                                    <td class="tab-table__td"
                                        onclick="toDetails('Departments', <?php echo $customerID; ?>, <?php echo $department->getDepartmentID(); ?>)"><?php echo $department->getDepartmentName(); ?></td>
                                    <td class="tab-table__td"
                                        onclick="toDetails('Departments', <?php echo $customerID; ?>, <?php echo $department->getDepartmentID(); ?>)"><?php echo $department->getDepartmentComment(); ?></td>
                                    <td class="tab-table__td">
                                        <?php
                                        // Checking if there is a customer set
                                        if ($customerID == 0) {
                                        ...
                                        switch ($departmentStatus) {
                                            case 'Archived':
                                                ...
                                                <a class="deleteKnop" href="#" data-toggle="modal"
                                                   ...
                                                   onclick="setDepartmentIDModalCustomerEdit(<?php echo $department->getDepartmentID(); ?>)"><i
                                                            class="fas tab-table__icon">&#xf2ed;</i></a>
                                                <?php
                                                break;
                                            case 'Deleted':
                    ...
                    <div class="ce-overview__table">
                            ...
                            <div class="col-sm-12">
                                <form method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="customer__select">
                                                <select id="scanStatus" name="cbxDepartmentStatus" class="form-control"
                                                        onchange="updateTableStatus('Scans', 'scanStatus')">
                                                    <?php
                                                    // Checking if a status has been set
                                                    if ($scanStatus != "none") {
                                                        // Looping through the statusses and checking wich one is equeal
                                        ...
                                        <div class="col-sm-5">
                                            <div class="search__icon"><i class='fas search--icon'>&#xf002;</i></div>
                                            <input class="form-control input__filter" id="FilterScans" type="text"
                                                   placeholder="Search...">
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="add-container">
                                                <a href="#" class="btn add-container__btn" data-toggle="modal"
                                                   data-target="#addScanModal"><i class='fas add-container--icon'>&#xf055;</i>
                                                    Add scan</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <table class="tab-table table table-hover" id="filterTableScans">
                            ...
                            <tr class="tab-table__row">
                                <th class="tab-table__head">Name
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableScans', 0, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableScans', 0, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Start date
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableScans', 1, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableScans', 1, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">End date
                                    <div class="table__icon-top"
                                         onclick="sortTable('filterTableScans', 2, 'asc')"></div>
                                    <div class="table__icon-bottom"
                                         onclick="sortTable('filterTableScans', 2, 'desc')"></div>
                                </th>
                                <th class="tab-table__head">Actions</th>
                            </tr>
                            </thead>
                            ...
                            foreach ($listScans as $scan) {
                                ...
                                <tr class="tab-table__row filter__row">
                                    <td class="tab-table__td"
                                        onclick="toDetails('Departments', <?php echo $customerID; ?>, <?php echo $scan->getScanID(); ?>)"><?php echo $scan->getScanName(); ?></td>
                                    <td class="tab-table__td"
                                        onclick="toDetails('Departments', <?php echo $customerID; ?>, <?php echo $scan->getScanID(); ?> )"><?php echo $scan->getScanStartDate(); ?></td>
                                    <td class="tab-table__td"
                                        onclick="toDetails('Departments', <?php echo $customerID; ?>, <?php echo $scan->getScanID(); ?> )"><?php echo $scan->getScanEndDate(); ?></td>
                                    <td class="tab-table__td">
                                        ...
                                        switch ($scanStatus) {
                                            case 'Archived':
                                                ?>
                                                <a class="deleteKnop" href="#" data-toggle="modal"
                                                   data-target="#deleteScan" id='<?php echo $scan->getScanID(); ?>'
                                                   onclick="setScanIDModalCustomerEdit(<?php echo $scan->getScanID(); ?>)"><i
                                                            class="fas tab-table__icon">&#xf2ed;</i></a>
                                                <?php
                                                break;
                                            case 'Deleted':
                                            ...
                                            default:
                                                ?>
                                                <a class="deleteKnop" href="#" data-toggle="modal"
                                                   data-target="#archiveScan" id='<?php echo $scan->getScanID(); ?>'
                                                   onclick="setScanIDModalCustomerEdit(<?php echo $scan->getScanID(); ?>)"><i
                                                            class="fas tab-table__icon">&#xf187;</i></a>
                                                <?php
                                                break;
        ...
        <!--User add modal --->
        <div class="modal fade" id="addUserModal" tabindex="-1" role="add-user" aria-labelledby="add-user"
             aria-hidden="true">
                ...
                <div class="modal-content">
                        ...
                        <form method="POST" autocomplete="off">
                            ...
                            <div class="row ce--form-row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="phone" name="txtAdPhoneNumber" class="form-control ce--input"
                                           required/>
                                </div>
                            </div>
                            ...
                            <div class="row ce--form-row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="txtAddUserComment" class="form-control ce--input"
                                              rows="5"></textarea>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        = "" > Name < /label>
                            < input
                        type = "text"
                        name = "txtAddDepartmentName"
                        class
                        = "form-control ce--input"
                        required / >
                        < /div>
                        < /div>
        ...
        <!-- Scan add modal --->
        <div class="modal fade" id="addScanModal" tabindex="-1" role="add-scan" aria-labelledby="add-scan"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form method="POST" autocomplete="off">
                            ...
                            <div class="row ce--form-row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="txtAddScanIntroduction" class="form-control ce--input" rows="5"
                                              required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row ce--form-row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="txtAddScanReminder" class="form-control ce--input" rows="5"
                                              required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row ce--form-row">
                                <div class="col-sm-12">
                                    <label class="">Comment</label>
                                    <textarea name="txtAddScanComment" class="form-control ce--input"
                                              rows="5"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row ce--form-row">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control ce--input" name="txtQuestionair"
                                           id="searchTemplate" placeholder="type a template name">
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        tabindex = "-1"
                        role = "dialog"
                        aria - labelledby = "archiveContact"
                        aria - hidden = "true" >
                            < div
                        class
                        = "modal-dialog"
                        ...
                        data - dismiss = "modal" > Dismiss < /button>
                            < button
                        type = "submit"
                        name = "btnArchiveContact"
                        class
                        = "btn btn-primary"
                        id = "btnArchive" > Archive < /button>
                            < /div>
                            < /form>
                            < /div>
                            < /div>
                        ...
                        class
                        = "modal fade"
                        id = "archiveDepartment"
                        tabindex = "-1"
                        role = "dialog"
                        aria - labelledby = "archiveDepartment"
                        aria - hidden = "true" >
                            < div
                        class
                        = "modal-dialog"
