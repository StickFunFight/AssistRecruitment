...
?>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="customer__select">
                                    <select id="scanStatus" name="cbxStatusScans" class="form-control"
    ...
    <div id="popover-form" style="opacity: 0;">
        <a class="btn btn-warning btn-dup" scan-id="0">Dupliceren</a>
    </div>
                            ...
                            $('#btnDelete').click(function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        window.location.href = 'scan-list?status=<?php echo $scanStatus;?>'
                                    }
                                });
